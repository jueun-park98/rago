...
/**
 * @ast node
 * @declaredat /Users/jueunpark/Documents/gitJastadd/bachelor-thesis-jastadd/src/main/jastadd/OpenAPISpecification.ast:22
...
protected boolean print_visited = false;
  ...
  public String print() {
    ...
    print_visited = true;
    try {
            String result = "\"" + getName() + "\": " + getServerVariableObject();
            return result;
            }
    finally {
      print_visited = false;
